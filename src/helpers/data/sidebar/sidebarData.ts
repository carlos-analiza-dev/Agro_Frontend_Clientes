...
const generarAnimalesItems = (especies: { nombre: string }[] = []) => {
  return [
    {
      name: "Todos",
      href: "/animales",
...
const generarSanidadAnimalItems = (especies: { nombre: string }[] = []) => {
  return [
    {
      name: "Todos",
      href: "/sanidad-animal",
...
export const generateNavItems = (especies: { nombre: string }[] = []) => {
  const animalesItems = generarAnimalesItems(especies);
  const sanidadAnimalItems = generarSanidadAnimalItems(especies);
