...
const ActividadesPage = () => {
  ...
  const handleEstadoChange = (estado: string) => {
    ...
    const nuevosFiltros: Partial<FiltrosActividades> = {
      offset: 0,
    };
  ...
  return (
    <div id="id-actividades-container" className="min-h-screen">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        ...
        <Card id="id-filtros-actividades" className="mb-6 shadow-lg border-0">
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle
                id="id-title-filtros-actividades"
              ...
              {isMobile && (
                <Button
                  id="toggle-filtros-actividades-btn"
                  variant="ghost"
                  size="sm"
          ...
          {(!isMobile || filtrosAbiertos) && (
            <CardContent id="id-filtros-actividades-content" className="pt-0">
              <FiltrosContent />
            </CardContent>
          )}
        </Card>

        <div id="id-estados-actividades" className="mb-6 overflow-x-auto pb-2">
          <Tabs
            id="id-tabs-estados-actividades"
            value={estadoActivo}
            onValueChange={handleEstadoChange}
            className="w-full min-w-max"
          >
            <TabsList
              id="id-tabs-list-estados-actividades"
              className="inline-flex h-auto p-1 bg-gray-100 dark:bg-gray-800 rounded-lg"
            >
              <TabsTrigger
                id="id-estado-todos"
                value="todos"
        ...
        <div id="id-contenido-actividades">
          {isLoading ? (
            <div id="id-loading-actividades">
              <SkeletonCard />
            </div>
          ) : actividadesData?.actividades?.length === 0 ? (
            <Alert
              id="id-empty-actividades"
            ...
            <>
              ...
              <div
                id="id-resumen-actividades"
                className="mt-4 text-center text-xs sm:text-sm text-gray-500 dark:text-gray-400"
              >
